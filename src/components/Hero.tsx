        ...
        <div className="text-center lg:text-left">
          <div className="mb-4 flex justify-center lg:justify-start animate-fade-up">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-primary/25 bg-gradient-to-r from-primary/10 to-chart-2/10 px-4 py-2 text-sm font-medium text-primary shadow-sm transition-all motion-safe:hover:scale-[1.02] motion-safe:hover:shadow-md motion-reduce:hover:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
